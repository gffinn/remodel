...
const FloorPlanComponent: React.FC = () => {
    ...
    return (
        <div className={styles.floorPlan}>
            ...
            <div className={styles.room} id={styles.masterBathroom} onMouseMove={handleMouseMove}>
            ...
            <div className={styles.room} id={styles.masterBed} onMouseMove={handleMouseMove}>
